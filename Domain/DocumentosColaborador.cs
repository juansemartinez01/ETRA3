...
namespace Domain
{
    public class DocumentosColaborador
    {
        ...
        public string AgregarDocumento(string nombre, byte[] documento, string extension, int tipoMultimedia, int legajoColaborador)
        {
            ColaboradorDao colaboradorDocumento = new ColaboradorDao();

            string var = colaboradorDocumento.AgregarDocumento(nombre,documento,extension, tipoMultimedia, legajoColaborador);
            return var;
        }
