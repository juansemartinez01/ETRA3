...
INSERT INTO Evento VALUES ('Bienvenido/a Agustina Micaela Troncoso schneider.',1,0, null)
...
INSERT INTO MovimientosCuentaColaborador VALUES (GETDATE(),GETDATE(),(SELECT MAX(legajo) FROM Colaborador), (SELECT MAX(numeroCuenta) FROM CuentaColaborador),0,3,0, null)
...
INSERT INTO HistorialSalario VALUES (GETDATE(),NULL,(SELECT MAX(id_salario) FROM Salario),(SELECT MAX(legajo) FROM Colaborador),0)
INSERT INTO Evento VALUES ('Bienvenido/a Emilce Ailen Schneider.',1,0, null)
INSERT INTO HistorialEvento VALUES ((SELECT MAX(id_evento) FROM Evento),GETDATE(),GETDATE(),GETDATE(),(SELECT MAX(legajo) FROM Colaborador),0)
INSERT INTO HistorialCargo VALUES (11,GETDATE(),NULL,(SELECT MAX(legajo) FROM Colaborador),0)
...
INSERT INTO HistorialSalario VALUES (GETDATE(),NULL,(SELECT MAX(id_salario) FROM Salario),(SELECT MAX(legajo) FROM Colaborador),0)
INSERT INTO Evento VALUES ('Bienvenido/a Alberto Martin  Pereyra .',1,0, null)
INSERT INTO HistorialEvento VALUES ((SELECT MAX(id_evento) FROM Evento),GETDATE(),GETDATE(),GETDATE(),(SELECT MAX(legajo) FROM Colaborador),0)
...
INSERT INTO HistorialSalario VALUES (GETDATE(),NULL,(SELECT MAX(id_salario) FROM Salario),(SELECT MAX(legajo) FROM Colaborador),0)
INSERT INTO Evento VALUES ('Bienvenido/a Diego Sergio  Sequier .',1,0, null)
INSERT INTO HistorialEvento VALUES ((SELECT MAX(id_evento) FROM Evento),GETDATE(),GETDATE(),GETDATE(),(SELECT MAX(legajo) FROM Colaborador),0)
INSERT INTO HistorialCargo VALUES (6,GETDATE(),NULL,(SELECT MAX(legajo) FROM Colaborador),0)
...
INSERT INTO HistorialSalario VALUES (GETDATE(),NULL,(SELECT MAX(id_salario) FROM Salario),(SELECT MAX(legajo) FROM Colaborador),0)
INSERT INTO Evento VALUES ('Bienvenido/a Agustin Perez.',1,0, null)
INSERT INTO HistorialEvento VALUES ((SELECT MAX(id_evento) FROM Evento),GETDATE(),GETDATE(),GETDATE(),(SELECT MAX(legajo) FROM Colaborador),0)
...
INSERT INTO HistorialSalario VALUES (GETDATE(),NULL,(SELECT MAX(id_salario) FROM Salario),(SELECT MAX(legajo) FROM Colaborador),0)
INSERT INTO Evento VALUES ('Bienvenido/a Carla Soledad Soto.',1,0, null)
INSERT INTO HistorialEvento VALUES ((SELECT MAX(id_evento) FROM Evento),GETDATE(),GETDATE(),GETDATE(),(SELECT MAX(legajo) FROM Colaborador),0)
...
INSERT INTO HistorialSalario VALUES (GETDATE(),NULL,(SELECT MAX(id_salario) FROM Salario),(SELECT MAX(legajo) FROM Colaborador),0)
INSERT INTO Evento VALUES ('Bienvenido/a Elias Simbron.',1,0, null)
INSERT INTO HistorialEvento VALUES ((SELECT MAX(id_evento) FROM Evento),GETDATE(),GETDATE(),GETDATE(),(SELECT MAX(legajo) FROM Colaborador),0)
...
INSERT INTO Salario VALUES (120000.0,0)
INSERT INTO HistorialSalario VALUES (GETDATE(),NULL,(SELECT MAX(id_salario) FROM Salario),(SELECT MAX(legajo) FROM Colaborador),0)
INSERT INTO Evento VALUES ('Bienvenido/a Lisandro Esteban  Ramayo .',1,0, null)
INSERT INTO HistorialEvento VALUES ((SELECT MAX(id_evento) FROM Evento),GETDATE(),GETDATE(),GETDATE(),(SELECT MAX(legajo) FROM Colaborador),0)
INSERT INTO HistorialCargo VALUES (6,GETDATE(),NULL,(SELECT MAX(legajo) FROM Colaborador),0)
INSERT INTO CuentaColaborador VALUES (0,0,-36000.0)
INSERT INTO MovimientosCuentaColaborador VALUES (GETDATE(),GETDATE(),(SELECT MAX(legajo) FROM Colaborador), (SELECT MAX(numeroCuenta) FROM CuentaColaborador),0,3,0, null)
...
INSERT INTO HistorialSalario VALUES (GETDATE(),NULL,(SELECT MAX(id_salario) FROM Salario),(SELECT MAX(legajo) FROM Colaborador),0)
INSERT INTO Evento VALUES ('Bienvenido/a Gustavo Ariel  Rodríguez Malanczuk .',1,0, null)
INSERT INTO HistorialEvento VALUES ((SELECT MAX(id_evento) FROM Evento),GETDATE(),GETDATE(),GETDATE(),(SELECT MAX(legajo) FROM Colaborador),0)
...
INSERT INTO HistorialSalario VALUES (GETDATE(),NULL,(SELECT MAX(id_salario) FROM Salario),(SELECT MAX(legajo) FROM Colaborador),0)
INSERT INTO Evento VALUES ('Bienvenido/a Enzo Rivadeneira.',1,0, null)
INSERT INTO HistorialEvento VALUES ((SELECT MAX(id_evento) FROM Evento),GETDATE(),GETDATE(),GETDATE(),(SELECT MAX(legajo) FROM Colaborador),0)
INSERT INTO HistorialCargo VALUES (1,GETDATE(),NULL,(SELECT MAX(legajo) FROM Colaborador),0)
...
INSERT INTO HistorialSalario VALUES (GETDATE(),NULL,(SELECT MAX(id_salario) FROM Salario),(SELECT MAX(legajo) FROM Colaborador),0)
INSERT INTO Evento VALUES ('Bienvenido/a Leandro Imas.',1,0, null)
INSERT INTO HistorialEvento VALUES ((SELECT MAX(id_evento) FROM Evento),GETDATE(),GETDATE(),GETDATE(),(SELECT MAX(legajo) FROM Colaborador),0)
INSERT INTO HistorialCargo VALUES (6,GETDATE(),NULL,(SELECT MAX(legajo) FROM Colaborador),0)
...
INSERT INTO HistorialSalario VALUES (GETDATE(),NULL,(SELECT MAX(id_salario) FROM Salario),(SELECT MAX(legajo) FROM Colaborador),0)
INSERT INTO Evento VALUES ('Bienvenido/a Nicolas Nahuel Chavez.',1,0, null)
INSERT INTO HistorialEvento VALUES ((SELECT MAX(id_evento) FROM Evento),GETDATE(),GETDATE(),GETDATE(),(SELECT MAX(legajo) FROM Colaborador),0)
INSERT INTO HistorialCargo VALUES (1,GETDATE(),NULL,(SELECT MAX(legajo) FROM Colaborador),0)
...
INSERT INTO HistorialSalario VALUES (GETDATE(),NULL,(SELECT MAX(id_salario) FROM Salario),(SELECT MAX(legajo) FROM Colaborador),0)
INSERT INTO Evento VALUES ('Bienvenido/a Facundo Agustin Ludueña.',1,0, null)
INSERT INTO HistorialEvento VALUES ((SELECT MAX(id_evento) FROM Evento),GETDATE(),GETDATE(),GETDATE(),(SELECT MAX(legajo) FROM Colaborador),0)
...
INSERT INTO Salario VALUES (105000.0,0)
INSERT INTO HistorialSalario VALUES (GETDATE(),NULL,(SELECT MAX(id_salario) FROM Salario),(SELECT MAX(legajo) FROM Colaborador),0)
INSERT INTO Evento VALUES ('Bienvenido/a Julián  Imas.',1,0, null)
INSERT INTO HistorialEvento VALUES ((SELECT MAX(id_evento) FROM Evento),GETDATE(),GETDATE(),GETDATE(),(SELECT MAX(legajo) FROM Colaborador),0)
...
INSERT INTO Salario VALUES (203000.0,0)
INSERT INTO HistorialSalario VALUES (GETDATE(),NULL,(SELECT MAX(id_salario) FROM Salario),(SELECT MAX(legajo) FROM Colaborador),0)
INSERT INTO Evento VALUES ('Bienvenido/a Antonio Alemany.',1,0, null)
INSERT INTO HistorialEvento VALUES ((SELECT MAX(id_evento) FROM Evento),GETDATE(),GETDATE(),GETDATE(),(SELECT MAX(legajo) FROM Colaborador),0)
INSERT INTO HistorialCargo VALUES (1,GETDATE(),NULL,(SELECT MAX(legajo) FROM Colaborador),0)
INSERT INTO CuentaColaborador VALUES (0,0,-60900.0)
INSERT INTO MovimientosCuentaColaborador VALUES (GETDATE(),GETDATE(),(SELECT MAX(legajo) FROM Colaborador), (SELECT MAX(numeroCuenta) FROM CuentaColaborador),0,3,0, null)
...
INSERT INTO HistorialSalario VALUES (GETDATE(),NULL,(SELECT MAX(id_salario) FROM Salario),(SELECT MAX(legajo) FROM Colaborador),0)
INSERT INTO Evento VALUES ('Bienvenido/a Sergio Gabriel  Cuggino.',1,0, null)
INSERT INTO HistorialEvento VALUES ((SELECT MAX(id_evento) FROM Evento),GETDATE(),GETDATE(),GETDATE(),(SELECT MAX(legajo) FROM Colaborador),0)
...
INSERT INTO Salario VALUES (105000.0,0)
INSERT INTO HistorialSalario VALUES (GETDATE(),NULL,(SELECT MAX(id_salario) FROM Salario),(SELECT MAX(legajo) FROM Colaborador),0)
INSERT INTO Evento VALUES ('Bienvenido/a Leonardo Rogelio  Moyano.',1,0, null)
INSERT INTO HistorialEvento VALUES ((SELECT MAX(id_evento) FROM Evento),GETDATE(),GETDATE(),GETDATE(),(SELECT MAX(legajo) FROM Colaborador),0)
...
INSERT INTO Salario VALUES (105000.0,0)
INSERT INTO HistorialSalario VALUES (GETDATE(),NULL,(SELECT MAX(id_salario) FROM Salario),(SELECT MAX(legajo) FROM Colaborador),0)
INSERT INTO Evento VALUES ('Bienvenido/a Facundo Daniel Aparicio.',1,0, null)
INSERT INTO HistorialEvento VALUES ((SELECT MAX(id_evento) FROM Evento),GETDATE(),GETDATE(),GETDATE(),(SELECT MAX(legajo) FROM Colaborador),0)
...
INSERT INTO Salario VALUES (105000.0,0)
INSERT INTO HistorialSalario VALUES (GETDATE(),NULL,(SELECT MAX(id_salario) FROM Salario),(SELECT MAX(legajo) FROM Colaborador),0)
INSERT INTO Evento VALUES ('Bienvenido/a Maximiliano Ezequiel Di Lelle.',1,0, null)
INSERT INTO HistorialEvento VALUES ((SELECT MAX(id_evento) FROM Evento),GETDATE(),GETDATE(),GETDATE(),(SELECT MAX(legajo) FROM Colaborador),0)
INSERT INTO HistorialCargo VALUES (10,GETDATE(),NULL,(SELECT MAX(legajo) FROM Colaborador),0)
INSERT INTO CuentaColaborador VALUES (0,0,-31500.0)
INSERT INTO MovimientosCuentaColaborador VALUES (GETDATE(),GETDATE(),(SELECT MAX(legajo) FROM Colaborador), (SELECT MAX(numeroCuenta) FROM CuentaColaborador),0,3,0, null)
...
INSERT INTO HistorialSalario VALUES (GETDATE(),NULL,(SELECT MAX(id_salario) FROM Salario),(SELECT MAX(legajo) FROM Colaborador),0)
INSERT INTO Evento VALUES ('Bienvenido/a Joaquín Previgliano.',1,0, null)
INSERT INTO HistorialEvento VALUES ((SELECT MAX(id_evento) FROM Evento),GETDATE(),GETDATE(),GETDATE(),(SELECT MAX(legajo) FROM Colaborador),0)
INSERT INTO HistorialCargo VALUES (12,GETDATE(),NULL,(SELECT MAX(legajo) FROM Colaborador),0)
...
INSERT INTO HistorialSalario VALUES (GETDATE(),NULL,(SELECT MAX(id_salario) FROM Salario),(SELECT MAX(legajo) FROM Colaborador),0)
INSERT INTO Evento VALUES ('Bienvenido/a Jordan Xavier Oviedo.',1,0, null)
INSERT INTO HistorialEvento VALUES ((SELECT MAX(id_evento) FROM Evento),GETDATE(),GETDATE(),GETDATE(),(SELECT MAX(legajo) FROM Colaborador),0)
INSERT INTO HistorialCargo VALUES (10,GETDATE(),NULL,(SELECT MAX(legajo) FROM Colaborador),0)
...
INSERT INTO HistorialSalario VALUES (GETDATE(),NULL,(SELECT MAX(id_salario) FROM Salario),(SELECT MAX(legajo) FROM Colaborador),0)
INSERT INTO Evento VALUES ('Bienvenido/a Hernan Gabriel Guardia.',1,0, null)
INSERT INTO HistorialEvento VALUES ((SELECT MAX(id_evento) FROM Evento),GETDATE(),GETDATE(),GETDATE(),(SELECT MAX(legajo) FROM Colaborador),0)
INSERT INTO HistorialCargo VALUES (4,GETDATE(),NULL,(SELECT MAX(legajo) FROM Colaborador),0)
...
/*Inicializador de la tabla Usuario*/
INSERT into Usuario (id_perfil,mail,contraseña,legajoColaborador,borradoLogico) VALUES (1,'admin@admin.com','7dGUwNjnZL5qyiV',10000,0)
